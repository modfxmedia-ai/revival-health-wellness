...
const TITLE = "Vitamin Injections";
const PATH = "/vitamin-injections";
const DESCRIPTION =
  "Discover Vitamin Injections at Revival Health & Wellness, a personalized, physician-led approach designed to help you look and feel your best.";
