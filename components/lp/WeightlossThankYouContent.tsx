...
const NEXT_STEPS = [
  ...
  {
    icon: Timer,
    title: "Your $79 experience",
    text: "Your visit includes a comprehensive consultation, a Styku 3D body scan, and a complimentary Lipolean injection.",
  },
];

const KEY_BENEFITS = [
  "Styku 3D body scan included",
  "Personalized plan, not a generic diet",
  "Complimentary Lipolean Fat Burner Injection",
  "Licensed medical team, zero pressure",
];

/** Thank-you page shown after the Weight Loss offer lead form is submitted. */
export default function WeightlossThankYouContent() {
  return (
    <>
      {/* ═══════════════════════ CONFIRMATION HERO ═══════════════════════ */}
      <section className="relative overflow-hidden bg-revival-dark py-20 lg:py-28">
        ...
        <div className="relative mx-auto max-w-2xl px-4 text-center sm:px-6 lg:px-8">
          ...
          >
            Your request for the $79 Weight Loss Experience has been
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="mt-4 font-heading text-3xl leading-tight text-revival-dark sm:text-4xl">
              A quick reminder of what your visit includes.
            </h2>
          </motion.div>
      ...
      <GoogleReviewsSection limit={3} treatment="Weight Loss" />
    </>
  );
}
